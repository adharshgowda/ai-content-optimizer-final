...
export default function GeneratorCard({ onGenerated }) {
  const [topic, setTopic] = useState('AI in Marketing');
  const [platform, setPlatform] = useState('Twitter');
  const [keywords, setKeywords] = useState('#AI,#Marketing');
  const [audience, setAudience] = useState('digital marketers');
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '1rem' }}>
              <div style={S.fieldGroup}>
                ...
                <div style={{ position: 'relative' }}>
                  <input type="range" min="20" max="200" value={wordCount} onChange={e => setWordCount(e.target.value)}
