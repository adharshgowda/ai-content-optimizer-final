...
export default function HomeDashboard({ onNavigate }) {
  ...
  const features = [
    ...
    },
    {
      id: 'abtest',
      title: 'A/B Predictor',
      description: 'Pit two variations against each other. Our ML model predicts the winner automatically.',
    ...
    },
    {
      ...
      description: 'Broadcast reports and A/B test winners directly to your marketing teams Slack channel.',
      icon: Slack,
      color: '#d29922'
    }
  ];
      ...
      <div style={{display: 'flex', gap: '4rem', marginBottom: '4rem', alignItems: 'center'}}>
        ...
        <div style={{flex: '1.5', paddingRight: '2rem'}}>
          ...
          <p style={{fontSize: '1.25rem', color: 'var(--text-muted)', maxWidth: '90%', lineHeight: 1.6, marginBottom: '2.5rem', fontWeight: 400}}>
            An end-to-end AI workspace. Generate copy, scrape competitor blogs, predict A/B testing winners, and route live analytics directly to your team's Slack.
          </p>
